...
export const SpecialtyCard: FC<TSpecialtyCardProps> = ({ data, onDelete, onEdit }) => {
    ...
    >
      ...
      <div className="py-2">
        ...
        <ul className={cn(!toggleOpportunities ? 'hidden' : 'flex flex-wrap items-center gap-2')}>
          {specialtyItem.careerOpportunities.map((careerItem, idx) => (
